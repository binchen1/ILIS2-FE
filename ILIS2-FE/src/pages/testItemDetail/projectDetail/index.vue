<template>
  <div class="projectDetail">
    <div class="projectDetail-title">
      ...
      <span class="projectDetail-title-tag">{{ status==0?'检测中':'已结束' }}</span>
    </div>
    ...
    <div class="projectDetail-tab">
      <div class="projectDetail-tab-btn">
        <router-link :to="`/`">检测报告</router-link>
        <router-link :to="`/otherAchievement`">其它成果</router-link>
        <router-link :to="`/appendix`">附录</router-link>
        <router-link :to="`/contractAndWorks`">合同段/单位工程</router-link>
        <router-link :to="`/progressManage`">进度管理</router-link>
